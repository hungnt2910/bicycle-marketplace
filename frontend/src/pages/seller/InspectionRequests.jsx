  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <Button variant="primary">+ Gửi yêu cầu mới</Button>
      </div>
              ...
              <div className="flex-1">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-sm text-neutral-600">Yêu cầu ngày: {request.requestDate}</p>
                  </div>
                  ...
                  <div className="bg-success-50 border border-success-200 rounded-lg p-4 mb-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-center">
                        <div className="text-3xl font-bold text-success-600">{request.score}</div>
                ...
                {request.status === 'in-progress' && (
                  <div className="bg-info-50 border border-info-200 rounded-lg p-4 mb-4">
                    ...
                    <p className="text-sm text-info-800 mt-1">Đang tiến hành kiểm định...</p>
                  </div>
                )}
