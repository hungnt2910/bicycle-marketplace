                        ...
                        <div className="flex gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex items-center gap-6 text-sm text-neutral-600 mb-3">
                                    <span>Giá: <strong className="text-primary-600">{listing.price.toLocaleString('vi-VN')} ₫</strong></span>
                                    <span>{listing.views} lượt xem</span>
                                    <span>{listing.likes} yêu thích</span>
                                </div>
                                <div className="flex gap-2">
                                    <Button variant="outline" size="sm">Chỉnh sửa</Button>
                                    <Button variant="outline" size="sm">Xem tin</Button>
                                    {listing.status === 'active' && (
                                        <Button variant="outline" size="sm">Ẩn tin</Button>
                                    )}
