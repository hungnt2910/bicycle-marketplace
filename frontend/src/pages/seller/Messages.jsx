...
const Messages = () => {
    ...
    return (
        <div className="space-y-6">
            {/* Header */}
            <div>
                <h2 className="text-2xl font-bold text-neutral-900">Tin nhắn</h2>
                <p className="text-neutral-600 mt-1">Trò chuyện với người mua</p>
            </div>
            ...
            <Card className="overflow-hidden">
                <div className="grid lg:grid-cols-3 h-[600px]">
                    {/* Conversations List */}
                    <div className="lg:col-span-1 border-r border-neutral-200 overflow-y-auto">
                        ...
                        <div>
                            {conversations.map((conv) => (
                                <div
                                    ...
                                    className={`p-4 border-b border-neutral-100 cursor-pointer hover:bg-neutral-50 transition-colors ${selectedChat === conv.id ? 'bg-primary-50' : ''
                                        }`}
                                >
                        ...
                        <div className="flex-1 overflow-y-auto p-4 bg-neutral-50">
                            <div className="space-y-4">
                                {messages.map((message) => (
                                    ...
                                    >
                                        <div
                                            className={`max-w-[70%] rounded-lg p-3 ${message.sender === 'seller'
                                        ...
                                        >
                                            ...
                                            <p
                                                className={`text-xs mt-1 ${message.sender === 'seller' ? 'text-primary-100' : 'text-neutral-500'
                                                    }`}
                                            >
                                                {message.time}
                                            </p>
