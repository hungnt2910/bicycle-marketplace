                ...
                <div className="container-custom">
                    <div className="flex items-center justify-between h-16 px-4 md:px-0">
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-lg md:text-2xl font-bold gradient-text">Bicycle-Marketplace</h1>
                        </div>
                        <div className="flex items-center gap-2 md:gap-4">
                            <a href="#features" className="hidden md:inline text-neutral-700 hover:text-primary-600 font-medium">
                                Tính năng
                            </a>
                            <a href="#how-it-works" className="hidden md:inline text-neutral-700 hover:text-primary-600 font-medium">
                                Cách hoạt động
                            </a>
                            <Button variant="outline" size="sm" onClick={() => onNavigate && onNavigate('login')}>
                                Đăng nhập
                            </Button>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6 animate-slide-up">
                            ...
                            <p className="text-xl text-neutral-600 leading-relaxed">
                                Nền tảng mua bán xe đạp thể thao chuyên nghiệp với hệ thống kiểm định,
                                ký quỹ an toàn và cộng đồng tin cậy.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                ...
                                <Button variant="primary" className="h-12 md:h-14 px-6 md:px-8" onClick={handleSearch}>
                                    Tìm kiếm
                                </Button>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-4 pt-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-medium text-neutral-700">Kiểm định chuyên nghiệp</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="text-2xl"></span>
                ...
                <div className="container-custom">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {categories.map((category, index) => (
                            ...
                            >
                                <div className={`w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-r ${category.color} flex items-center justify-center text-4xl transform group-hover:scale-110 transition-transform`}>
                                    {category.icon}
                                </div>
                ...
                <div className="container-custom">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {featuredBikes.map((bike) => (
                            <Card key={bike.id} variant="product" className="overflow-hidden cursor-pointer hover-lift" onClick={() => handleProductClick(bike.id)}>
